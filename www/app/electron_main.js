...
var isOsSupported = isWindows || isLinux;
...
main_1.main({
    ...
    getPersistentServerFactory: function () {
        return function (serverId, config, eventQueue) {
            return new outline_server_1.OutlineServer(serverId, config, isOsSupported ? new windows_connection_1.WindowsOutlineConnection(config, serverId) :
