...
(function (shared, scope, testing) {
  ...
  var AnimationEvent = function AnimationEvent(target, currentTime, timelineTime) {
    this.target = target;
  ...
  scope.Animation.prototype = {
    ...
    _tickCurrentTime: function _tickCurrentTime(newTime, ignoreLimit) {
    ...
    _fireEvents: function _fireEvents(baseTime) {
      if (this._isFinished) {
    ...
    _tick: function _tick(timelineTime, isAnimationFrame) {
